...
const MasterProjects: React.FC = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-2xl font-bold text-blue-600 mb-6">All Projects</h1>
            ...
            <form onSubmit={handleSubmit} className="px-6 py-4 space-y-4">
              ...
              <div>
                ...
                <input
                  type="text"
                  value={
                    typeof users.find((u) => u._id === form.manager)?.name ===
                    "string"
                      ? users.find((u) => u._id === form.manager)?.name
                      : "N/A"
                  }
                  readOnly
                  className="w-full mt-1 px-3 py-2 border rounded-lg bg-gray-100 text-gray-700 cursor-not-allowed"
                />
              </div>
              ...
              <div>
                ...
                <CustomDropdown
                  ...
                  selected={form.members} // <-- this ensures pre-selection
